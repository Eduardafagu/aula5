...
//e "e" pode ser considerado um número
const number5=1e1
...
const boolean5 =number1 > number3 && number3 < number2;
...
console.log('pegando o tamanho total do nosso array2', array2.length);
console.log('pegando o primeiro item array2', array2 [0]);
...
const object3 = {
  ...
  contatos: [
  {tipo:'email', email: 'eduardafagundes@gmail.com'},
  {tipo: 'celular', celular:'+55 (51) 000-000-000'},
  ],
};
console.log(object3);
